...
let Technique = class Technique extends repository_1.Entity {
    constructor(data) {
        super(data);
    }
};
...
], Technique.prototype, "pid", void 0);
__decorate([
    repository_1.property({
        type: 'string',
        required: true,
    ...
    __metadata("design:type", String)
], Technique.prototype, "name", void 0);
__decorate([
    repository_1.hasMany(() => dataset_technique_model_1.DatasetTechnique),
    __metadata("design:type", Array)
], Technique.prototype, "datasetTechniques", void 0);
Technique = __decorate([
