...
let Parameter = class Parameter extends repository_1.Entity {
    constructor(data) {
        super(data);
    }
};
...
__decorate([
    ...
    __metadata("design:type", String)
], Parameter.prototype, "unit", void 0);
__decorate([
    repository_1.belongsTo(() => dataset_model_1.Dataset),
    __metadata("design:type", String)
], Parameter.prototype, "datasetId", void 0);
__decorate([
    repository_1.belongsTo(() => document_model_1.Document),
    __metadata("design:type", String)
], Parameter.prototype, "documentId", void 0);
