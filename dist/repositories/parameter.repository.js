...
let ParameterRepository = class ParameterRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, getDatasetRepository, getDocumentRepository) {
        super(models_1.Parameter, dataSource);
...
ParameterRepository = __decorate([
    ...
    __param(2, repository_1.repository.getter('DocumentRepository')),
